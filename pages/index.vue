...
export default {
  ...
  head() {
    return {
      title: "Cairo Campos - Desenvolvedor Front End",
      meta: [
        { 
          hid: 'description', 
          name: 'description', 
